		...
		<form method="POST" action="<?= $post_route ?>" id="update_profile_form" accept-charset="UTF-8" file="1" enctype="multipart/form-data">
			...
			<div class="well">
				...
				<?php elseif($user->role == 'admin'): ?>
					...
					<div class="clear"></div>
				<?php endif; ?>
				<a class="btn btn-primary" href="<?= ($settings->enable_https) ? secure_url('user') : URL::to('user'); ?><?= '/' . $user->username; ?>/billing" style="margin-top:10px;"><i class="fa fa-credit-card"></i> Manage Your Billing Info</a>
			</div>
