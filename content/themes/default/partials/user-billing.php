...
<?php elseif ($user->subscribed()): ?>
	...
	<a class="btn btn-danger cancel-account">Cancel My Account</a>
		<div class="cancel-account-confirmation">
			...
			<a class="btn btn-info cancel-cancel">No, keep my account active</a> <a class="btn btn-danger" href="<?= ($settings->enable_https) ? secure_url('/') : URL::to('user') ?><?= '/' . $user->username; ?>/cancel">Yes, Cancel My Account</a>
		</div>
	</div>
