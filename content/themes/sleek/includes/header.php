      ...
      <div class="container">
            ...
            <div class="collapse navbar-collapse right" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="/videos"><i class="hv-font hv-video"></i> Videos</a></li>
                        <li><a href="/posts"><i class="hv-font hv-book"></i> Articles</a></li>

                    <?php if(Auth::guest()): ?>
                        
                        <li><a href="/login"><i class="hv-font hv-enter"></i> Login</a></li>
                        <li><a href="/signup"><i class="hv-font hv-address-book"></i>  Signup</a></li>
